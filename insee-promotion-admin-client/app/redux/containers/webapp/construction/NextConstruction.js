...
class ConstructionDetail extends Component {
  ...
  constructor(props) {
    ...
    this._mapPropToState = this._mapPropToState.bind(this)
    this.isApproval = true;
  }


  shouldComponentUpdate(nextProp, nextState) {
    this._mapPropToState(nextProp, nextState)
    return true;
  }
  ...
  _mapPropToState(nextProp, nextState) {
    let app = nextProp.app;
    this.props.app != app && (nextState.construction = app.construction)
  }
