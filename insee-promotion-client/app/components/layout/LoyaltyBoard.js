            ...
            <div>
                {loyalty &&
                    <div className="ton-info">
                        <h5 className="ton-title">Số bao đã tích lũy</h5>
                ...
                {loyalty &&
                    <div className="ton-process">
                        <ul className="cdt-step-progressbar horizontal">
                            ...
                            <li className={`${ton >= 100 && 'active'}`} style={{ width: '20%' }}>
                                <span className="indicator"></span>
                                <span className="title">100</span>
                            </li>
                            <li className={`${ton >= 200 && 'active'}`} style={{ width: '25%' }}>
                                <span className="indicator"></span>
                                <span className="title">200</span>
                            </li>
                            <li className={`${ton >= 350 && 'active'}`} style={{ width: '25%' }}>
                                <span className="indicator"></span>
                                <span className="title">350</span>
                            </li>
                            <li className={`${ton >= 500 && 'active'}`} style={{ width: '25%' }}>
                                <span className="indicator"></span>
