...
export const POWERS = new CementEnum(1, "INSEE Power-S 50kg", 1);
export const WALL_PRO = new CementEnum(2, "INSEE Wall Pro 40kg", 1);
export const LAVILLA_EXTRA_CC40 = new CementEnum(3, "Lavilla Xtra 50kg", 1);
export const EXTRA_DURABLE_HOUSING = new CementEnum(4, "INSEE Extra Durable 50kg", 1);
