...
import com.vn.insee.zalobot.worker.script.upload_bill.question.CementQuestion;
...
public class CementLoyaltyQuestion extends Question {
    private static final Logger LOGGER = LogManager.getLogger(CementLoyaltyQuestion.class);
    private List<Integer> cementIds;
    private int selectedCement;

    public CementLoyaltyQuestion(List<Integer> cementIds) {
